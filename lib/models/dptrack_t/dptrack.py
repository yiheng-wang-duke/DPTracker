...
from lib.models.dptrack_t.vision_transformer import vit_tiny_patch16_224
...
class DPTrackT(nn.Module):
    """ This is the base class for DPTracker-Tiny"""

    def __init__(self, transformer, box_head, aux_loss=False, head_type="CORNER", training=True):
...
def build_dptrackt(cfg, training=True):
    ...
    # don't change it into DPTrack, we start training from pretrained AVTrack
