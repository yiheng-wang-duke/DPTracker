...
def create_default_local_file_ITP_train(workspace_dir, data_dir):
    ...
    default_settings = OrderedDict({
        ...
        'davis_dir': empty_str,
        'youtubevos_dir': empty_str,
        # nighttime general tracking
        'bdd100k_night_dir': os.path.join(data_dir, 'bdd100k_night'),
        'exdark_dir': os.path.join(data_dir, 'ExDark'),
        'shift_night_dir': os.path.join(data_dir, 'shift_night'),
        })
