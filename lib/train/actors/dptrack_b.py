...
class DPTrackBActor(BaseActor):
    """ Actor for training DPTrackB models """
    ...
    def compute_losses(self, pred_dict, gt_dict, return_status=True):
        ...
        giou_loss, iou = self.objective['giou'](pred_boxes_vec, gt_boxes_vec, gt_dict['confidence'])  # (BN,4) (BN,4)
        # try:
        #     giou_loss, iou = self.objective['giou'](pred_boxes_vec, gt_boxes_vec, gt_dict[])  # (BN,4) (BN,4)
        # except:
