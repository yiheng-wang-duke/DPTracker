...
class EnvSettings_ITP:
    def __init__(self, workspace_dir, data_dir, save_dir):
        ...
        self.nat2021_path = os.path.join(data_dir, 'NAT2021')
        self.uavdark135_path = os.path.join(data_dir, 'UAVDark135')
        self.darktrack2021_path = os.path.join(data_dir, 'DarkTrack2021')
        # self.uav123_10fps_path = os.path.join(data_dir, 'UAV123')
        ...
        # self.uavtrack112 = os.path.join(data_dir, 'UAVTrack112')
